...
def test_check_incorrect_username():
    ...
    # For systems with 114 Chrome or below: driver = webdriver.Chrome(
    #    service=Service(r"C:\\Users\\Katy\\katerynaAQA" + "chromedriver.exe")
    #    )
    # For systems with 115 Chrome or above:
